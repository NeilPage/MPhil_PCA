...
dfPCA = pd.read_csv('/Users/ncp532/Documents/Data/MERRA2/PCA_Variables2.csv', index_col=0)
...
#dfPCA['sqrt_SurfBrO'] = np.sqrt(dfPCA['SurfBrO2'])
...
SwansonVariables    = dfPCA_Standard3.drop(['SurfBrO','LTBrO','sqrt_SurfBrO','sqrt_LTBrO','AEC','WindDir','SolRad','IceContact','IceContact100m',
                                            ...
                                            'Weighted_Land','Weighted_Ocean','Percentage_Ice','Percentage_Land','Percentage_Ocean','Chlorophyll'], 1)
...
AdditionalVariables = dfPCA_Standard3.drop(['SurfBrO','LTBrO','sqrt_SurfBrO','sqrt_LTBrO','AEC','IceContact100m','IceContactMLH','IceContactPerc',
                                            ...
                                            'Percentage_Ice','Percentage_Land','Percentage_Ocean','PTDif1000m'], 1)
...
BrOSurfVariables    = dfPCA_Standard3.drop(['SurfBrO','LTBrO','sqrt_SurfBrO','sqrt_LTBrO','AEC','IceContact100m','IceContactMLH','IceContactPerc',
                                            'LandContact','LandContactMLH','OceanContact','Weighted_Ice','Weighted_Land','Weighted_Ocean',
                                            'Percentage_Ice','Percentage_Land','Percentage_Ocean','PTDif1000m','MLH','P1hr','SurfPres','log_AEC','WindDir','Chlorophyll'], 1)

BrOSurfVariables2   = dfPCA.drop(['SurfBrO','LTBrO','sqrt_SurfBrO','sqrt_LTBrO','AEC','IceContact100m','IceContactMLH','IceContactPerc',
                                            'LandContact','LandContactMLH','OceanContact','Weighted_Ice','Weighted_Land','Weighted_Ocean',
                                            'Percentage_Ice','Percentage_Land','Percentage_Ocean','PTDif1000m','MLH','P1hr','SurfPres','log_AEC','WindDir','Chlorophyll'], 1)
...
BrOLTcolVariables   = dfPCA_Standard3.drop(['SurfBrO','LTBrO','sqrt_SurfBrO','sqrt_LTBrO','AEC','IceContact100m','IceContactMLH','IceContactPerc',
                                            'LandContact','LandContactMLH','OceanContact','Weighted_Ice','Weighted_Land','Weighted_Ocean',
                                            'Percentage_Ice','Percentage_Land','Percentage_Ocean','P1hr'], 1)
...
# BrO Surf
dataPCA_S  = pd.DataFrame({'PC1': PC1_S, 'PC2': PC2_S, 'PC3': PC3_S, 'PC4': PC4_S, 'PC5': PC5_S, 'PC6': PC6_S, 'PC7': PC7_S, 'z': dfPCA['sqrt_SurfBrO']})

# BrO LTcol
dataPCA_LT = pd.DataFrame({'PC1': PC1_LT, 'PC2': PC2_LT, 'PC3': PC3_LT, 'PC4': PC4_LT, 'PC5': PC5_LT, 'PC6': PC6_LT, 'PC7': PC7_LT, 'PC8': PC8_LT, 'PC9': PC9_LT, 'PC10': PC10_LT, 'PC11': PC11_LT, 'PC12': PC12_LT, 'PC13': PC13_LT, 'z': dfPCA['sqrt_LTBrO']})

# Fit the model
model_PC_Surf  = ols("z ~ PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7", dataPCA_S).fit()  # Surface StatsModel (ols)
model_PC_LTcol = ols("z ~ PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + PC11 + PC12 + PC13", dataPCA_LT).fit() # LTcol StatsModel (ols)
...
OLS_PC_5LT  = Model_results_PC_LTcol[5]  # Coefficient PC5
OLS_PC_6LT  = Model_results_PC_LTcol[6]  # Coefficient PC6
OLS_PC_7LT  = Model_results_PC_LTcol[7]  # Coefficient PC7
OLS_PC_8LT  = Model_results_PC_LTcol[8]  # Coefficient PC8
OLS_PC_9LT  = Model_results_PC_LTcol[9]  # Coefficient PC9
OLS_PC_10LT = Model_results_PC_LTcol[10] # Coefficient PC10
OLS_PC_11LT = Model_results_PC_LTcol[11] # Coefficient PC11
OLS_PC_12LT = Model_results_PC_LTcol[12] # Coefficient PC12
OLS_PC_13LT = Model_results_PC_LTcol[13] # Coefficient PC13
...
# My loadings
#--------------
Pred_BrOSurf_OLS  = np.square(OLS_PC_0S  + (OLS_PC_1S*PC1_S)   + (OLS_PC_2S*PC2_S)   + (OLS_PC_3S*PC3_S)   + (OLS_PC_4S*PC4_S)   + (OLS_PC_5S*PC5_S)   + (OLS_PC_6S*PC6_S)   + (OLS_PC_7S*PC7_S))
Pred_BrOLTcol_OLS = np.square(OLS_PC_0LT + (OLS_PC_1LT*PC1_LT) + (OLS_PC_2LT*PC2_LT) + (OLS_PC_3LT*PC3_LT) + (OLS_PC_4LT*PC4_LT) + (OLS_PC_5LT*PC5_LT) + (OLS_PC_6LT*PC6_LT) + (OLS_PC_7LT*PC7_LT) + (OLS_PC_8LT*PC8_LT) + (OLS_PC_9LT*PC9_LT) + (OLS_PC_10LT*PC10_LT) + (OLS_PC_11LT*PC11_LT) + (OLS_PC_12LT*PC12_LT) + (OLS_PC_13LT*PC13_LT))
...
# BrO Surf
#--------------
dfLinearRegressionS = pd.DataFrame({'R (BrO_Surf)':       [r_O3_S,   r_SurfTemp_S,   r_WS10m_S,   r_PTD100m_S,   r_SolRad_S,   r_IceContact_S,   r_SeaIceConc_S],
                                   'R^2 (BrO_Surf)':      [r2_O3_S,  r2_SurfTemp_S,  r2_WS10m_S,  r2_PTD100m_S,  r2_SolRad_S,  r2_IceContact_S,  r2_SeaIceConc_S],
                                   'p-value (BrO_Surf)':  [p_O3_S,   p_SurfTemp_S,   p_WS10m_S,   p_PTD100m_S,   p_SolRad_S,   p_IceContact_S,   p_SeaIceConc_S]})
dfLinearRegressionS.index = ['O3','SurfTemp','WS10m','PTD100m','SolRad','IceContact','SeaIceConc']
dfLinearRegressionS.to_csv('/Users/ncp532/Documents/Data/MERRA2/LinearRegressionS.csv')

#--------------
# BrO LTcol
#--------------
dfLinearRegressionLT = pd.DataFrame({'R (BrO_LTcol)':     [r_O3_LT,  r_AEC_LT,  r_SurfTemp_LT,  r_SLP_LT,  r_WS10m_LT,  r_MLH_LT,  r_PTD1000m_LT,  r_PTD100m_LT,  r_WindDir_LT,  r_SolRad_LT,  r_IceContact_LT,  r_SeaIceConc_LT,  r_Chloro_LT],
                                   'R^2 (BrO_LTcol)':     [r2_O3_LT, r2_AEC_LT, r2_SurfTemp_LT, r2_SLP_LT, r2_WS10m_LT, r2_MLH_LT, r2_PTD1000m_LT, r2_PTD100m_LT, r2_WindDir_LT, r2_SolRad_LT, r2_IceContact_LT, r2_SeaIceConc_LT, r2_Chloro_LT],
                                   'p-value (BrO_LTcol)': [p_O3_LT,  p_AEC_LT,  p_SurfTemp_LT,  p_SLP_LT,  p_WS10m_LT,  p_MLH_LT,  p_PTD1000m_LT,  p_PTD100m_LT,  p_WindDir_LT,  p_SolRad_LT,  p_IceContact_LT,  p_SeaIceConc_LT,  p_Chloro_LT]})
dfLinearRegressionLT.index = ['O3','AEC','SurfTemp','SLP','WS10m','MLH','PTD1000m','PTD100m','WindDir','SolRad','IceContact','SeaIceConc','Chlorophyll']
...
dataS      = BrOSurfVariables
dataS['z'] = dfPCA['sqrt_SurfBrO']
model_MLR_Surf  = ols("z ~ O3 + SurfTemp + WS10m + PTDif100m + SolRad + IceContact + SeaIceConc", dataS).fit()  # Surface StatsModel (ols)

dataLTcol      = BrOLTcolVariables
dataLTcol['z'] = dfPCA['sqrt_LTBrO']
model_MLR_LTcol = ols("z ~ O3 + log_AEC + SurfTemp + SurfPres + WS10m + MLH + PTDif1000m + PTDif100m + WindDir + SolRad + IceContact + SeaIceConc + Chlorophyll", dataLT).fit() # LTcol StatsModel (ols)
...
# Vif_O3              = vif_cal(input_data=dataS, dependent_col="O3")
# Vif_SurfPres        = vif_cal(input_data=dataS, dependent_col="SurfPres")
# Vif_SurfTemp        = vif_cal(input_data=dataS, dependent_col="SurfTemp")
# Vif_P1hr            = vif_cal(input_data=dataS, dependent_col="P1hr")
# Vif_PTDif100m       = vif_cal(input_data=dataS, dependent_col="PTDif100m")
# Vif_PTDif1000m      = vif_cal(input_data=dataS, dependent_col="PTDif1000m")
# Vif_WS10m           = vif_cal(input_data=dataS, dependent_col="WS10m")
# Vif_WindDir         = vif_cal(input_data=dataS, dependent_col="WindDir")
# Vif_MLH             = vif_cal(input_data=dataS, dependent_col="MLH")
# Vif_SolRad          = vif_cal(input_data=dataS, dependent_col="SolRad")
# Vif_IceContact      = vif_cal(input_data=dataS, dependent_col="IceContact")
# Vif_IceContact100m  = vif_cal(input_data=dataS, dependent_col="IceContact100m")
# Vif_IceContactMLH   = vif_cal(input_data=dataS, dependent_col="IceContactMLH")
# Vif_SeaIceConc      = vif_cal(input_data=dataS, dependent_col="SeaIceConc")
# Vif_IceContactPerc  = vif_cal(input_data=dataS, dependent_col="IceContactPerc")
# Vif_LandContact     = vif_cal(input_data=dataS, dependent_col="LandContact")
# Vif_LandContactMLH  = vif_cal(input_data=dataS, dependent_col="LandContactMLH")
# Vif_OceanContact    = vif_cal(input_data=dataS, dependent_col="OceanContact")
# Vif_Weighted_Ice    = vif_cal(input_data=dataS, dependent_col="Weighted_Ice")
# Vif_Weighted_Land   = vif_cal(input_data=dataS, dependent_col="Weighted_Land")
# Vif_Weighted_Ocean  = vif_cal(input_data=dataS, dependent_col="Weighted_Ocean")
# Vif_Percentage_Ice  = vif_cal(input_data=dataS, dependent_col="Percentage_Ice")
# Vif_Percentage_Land = vif_cal(input_data=dataS, dependent_col="Percentage_Land")
# Vif_Percantage_Ocean= vif_cal(input_data=dataS, dependent_col="Percentage_Ocean")
# Vif_Chlorophyll     = vif_cal(input_data=dataS, dependent_col="Chlorophyll")
# Vif_AEC             = vif_cal(input_data=dataS, dependent_col="log_AEC")
...
OLS_MLR_3S  = Model_results_MLR_Surf[2]  # Coefficient SurfTemp
#OLS_MLR_4S  = Model_results_MLR_Surf[4]  # Coefficient SurfPres
OLS_MLR_5S  = Model_results_MLR_Surf[3]  # Coefficient WS10m
...
OLS_MLR_9S  = Model_results_MLR_Surf[4]  # Coefficient PTD100m
...
#OLS_MLR_10S = Model_results_MLR_Surf[9] # Coefficient WindDir
OLS_MLR_11S = Model_results_MLR_Surf[5] # Coefficient SolRad
OLS_MLR_12S = Model_results_MLR_Surf[6] # Coefficient IceContact
OLS_MLR_13S = Model_results_MLR_Surf[7] # Coefficient SeaIceConc
#OLS_MLR_14S = Model_results_MLR_Surf[13] # Coefficient Chlorophyll
...
OLS_MLR_2LT  = Model_results_MLR_LTcol[2]  # Coefficient log_AEC
OLS_MLR_3LT  = Model_results_MLR_LTcol[3]  # Coefficient SurfTemp
OLS_MLR_4LT  = Model_results_MLR_LTcol[4]  # Coefficient SurfPres
...
OLS_MLR_7LT  = Model_results_MLR_LTcol[7]  # Coefficient PTD1000m
OLS_MLR_9LT  = Model_results_MLR_LTcol[8]  # Coefficient PTD100m
...
OLS_MLR_10LT = Model_results_MLR_LTcol[9] # Coefficient WindDir
OLS_MLR_11LT = Model_results_MLR_LTcol[10] # Coefficient SolRad
OLS_MLR_12LT = Model_results_MLR_LTcol[11] # Coefficient IceContact
OLS_MLR_13LT = Model_results_MLR_LTcol[12] # Coefficient SeaIceConc
OLS_MLR_14LT = Model_results_MLR_LTcol[13] # Coefficient Chlorophyll
...
Pred_BrOSurf_MLR  = np.square(OLS_MLR_0S  + (OLS_MLR_1S*BrOSurfVariables['O3'])   + (OLS_MLR_3S*BrOSurfVariables['SurfTemp'])  + (OLS_MLR_5S*BrOSurfVariables['WS10m'])      + (OLS_MLR_9S*BrOSurfVariables['PTDif100m'])  + (OLS_MLR_11S*BrOSurfVariables['SolRad'])   + (OLS_MLR_12S*BrOSurfVariables['IceContact'])   + (OLS_MLR_13S*BrOSurfVariables['SeaIceConc']))
Pred_BrOLTcol_MLR = np.square(OLS_MLR_0LT + (OLS_MLR_1LT*BrOLTcolVariables['O3']) + (OLS_MLR_2LT*BrOLTcolVariables['log_AEC']) + (OLS_MLR_3LT*BrOLTcolVariables['SurfTemp']) + (OLS_MLR_4LT*BrOLTcolVariables['SurfPres']) + (OLS_MLR_5LT*BrOLTcolVariables['WS10m']) + (OLS_MLR_6LT*BrOLTcolVariables['MLH']) + (OLS_MLR_7LT*BrOLTcolVariables['PTDif1000m']) + (OLS_MLR_9LT*BrOLTcolVariables['PTDif100m']) + (OLS_MLR_10LT*BrOLTcolVariables['WindDir']) + (OLS_MLR_11LT*BrOLTcolVariables['SolRad']) + (OLS_MLR_12LT*BrOLTcolVariables['IceContact']) + (OLS_MLR_13LT*BrOLTcolVariables['SeaIceConc']) + (OLS_MLR_14LT*BrOLTcolVariables['Chlorophyll']))
...
dfPC_IntCoef = {'Intercept (B0)':       [OLS_PC_0S, OLS_PC_0LT],
                ...
                'Coefficient 3 (B3)':   [OLS_PC_3S, OLS_PC_3LT],
                'Coefficient 4 (B4)':   [OLS_PC_4S, OLS_PC_4LT],
                'Coefficient 5 (B5)':   [OLS_PC_5S, OLS_PC_5LT],
                'Coefficient 6 (B6)':   [OLS_PC_6S, OLS_PC_6LT],
                'Coefficient 7 (B7)':   [OLS_PC_7S, OLS_PC_7LT],
                'Coefficient 8 (B8)':   [np.nan,    OLS_PC_8LT],
                'Coefficient 9 (B9)':   [np.nan,    OLS_PC_9LT],
                'Coefficient 10 (B10)': [np.nan,    OLS_PC_10LT],
                'Coefficient 11 (B11)': [np.nan,    OLS_PC_11LT],
                'Coefficient 12 (B12)': [np.nan,    OLS_PC_12LT],
                'Coefficient 13 (B13)': [np.nan,    OLS_PC_13LT]}
dfPC_IntCoef = pd.DataFrame(dfPC_IntCoef, index = ['ols_Surf','ols_LTcol'],columns = ['Intercept (B0)','Coefficient 1 (B1)','Coefficient 2 (B2)','Coefficient 3 (B3)','Coefficient 4 (B4)',
                                                                                      ...
                                                                                      'Coefficient 10 (B10)','Coefficient 11 (B11)','Coefficient 12 (B12)','Coefficient 13 (B13)'])
