...
stat_WindDir,      pval_WindDir      = stats.shapiro(dfPCA['WindDir'])

Rad_WD = np.radians(dfPCA['WindDir'])
...
# Plot the variables
plt.hist(dfPCA['WindDir'], density=False, bins=10, edgecolor = 'black', linewidth = 0.5)

test = stats.circstats.vonmisesmle(dfPCA['WindDir'])
...
# Plot the variables
plt.hist(Rad_WD, density=False, bins=10, edgecolor = 'black', linewidth = 0.5)
...
dfPC_IntCoef = {'Intercept (B0)':       [OLS_PC_0S, OLS_PC_0LT],
                ...
                'Coefficient 15 (B15)': [np.nan,    np.nan]}
