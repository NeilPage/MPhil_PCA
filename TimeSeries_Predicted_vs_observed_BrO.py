...
# MLR (OLS)
#BrO_SP_Met  = PC_BrO['MLR_BrOSurf']/1e13  # Surf BrO using OLS coefficients
#BrO_LTP_Met = PC_BrO['MLR_BrOLTcol']/1e13 # Ltcol BrO using OLS coefficients

# PLS
#BrO_SP_Met  = PC_BrO['PLS_BrOSurf']/1e13  # Surf BrO using OLS coefficients
#BrO_LTP_Met = PC_BrO['PLS_BrOLTcol']/1e13 # Ltcol BrO using OLS coefficients
...
SP_Met_Mavg,  date_avg = monthly(BrO_SP_Met,  Date) # BrO surface predictions Swanso coefficientsn
LTP_Met_Mavg, date_avg = monthly(BrO_LTP_Met, Date) # BrO LTcol predictions Swanson coefficients
SP_OLS_Mavg,  date_avg = monthly(BrO_SP_OLS,   Date) # BrO surface predictions My coefficients
LTP_OLS_Mavg, date_avg = monthly(BrO_LTP_OLS,  Date) # BrO LTcol predictions My coefficients
...
dfCorrCoef = pd.DataFrame(dfCorrCoef, columns = ['Linear (R)','Linear (R2)','Spearman (p)'],index = ['Surface Swanson','LTcol Swanson','Surface OLS','LTcol OLS'])#,'Surface M2 SurfPres','LTcol M2 SurfPres'])
