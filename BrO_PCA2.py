...
#-------------------------------
# Fit the MLR model
model_MLR_Surf  = ols("z ~ O3a + SurfTempa + WS10ma + PTD100ma", dataS).fit()  # Surface StatsModel (ols)
model_MLR_LTcol = ols("z ~ O3a + AECa + SurfTempa + SLPa + WS10ma + MLHa + PTD1000ma + PTD100ma", dataLT).fit() # LTcol StatsModel (ols)
...
OLS_MLR_8LT = Model_results_MLR_LTcol[7] # Coefficient PTD1000m
...
BrO_SurfPred_MLR_OLS = np.square(OLS_MLR_0S + (OLS_MLR_1S*Stand_O3) + (OLS_MLR_2S*Stand_SurfTempMet) + (OLS_MLR_3S*Stand_WS10mMet) + (OLS_MLR_4S*Stand_PTDif100m))
BrO_LTPred_MLR_OLS   = np.square(OLS_MLR_0LT + (OLS_MLR_1LT*Stand_O3) + (OLS_MLR_2LT*Stand_AEC) + (OLS_MLR_3LT*Stand_SurfTempMet) + (OLS_MLR_4LT*Stand_SurfPresMet) + (OLS_MLR_5LT*Stand_WS10mMet) + (OLS_MLR_6LT*Stand_MLH) + (OLS_MLR_7LT*Stand_PTDif1000m) + (OLS_MLR_8LT*Stand_PTDif100m))
...
df1.to_csv('/Users/ncp532/Documents/Data/MERRA2/BrO_Pred_CAMMPCAN_Test3.csv')
