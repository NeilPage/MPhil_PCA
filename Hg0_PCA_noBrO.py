...
#--------------
dfPCA = pd.read_csv('/Users/ncp532/Documents/Data/PCA_Hg0/Without_BrO/PCA_EnvVar.csv', index_col=0)
dfPCA = dfPCA.dropna()
...
# All Variables
All_Variables = dfPCA_Standard3.drop(['IceContactPerc','LandContactMLH','ng/m3','P1hr','WindDir','IceContact100m','IceContactMLH',
                                      'LandContact','OceanContact','Water_Sal','sqrt_Hg0'], 1)

# Hg0 Varaiables
Hg0_Variables = dfPCA_Standard3.drop(['IceContactPerc','LandContactMLH','ng/m3','P1hr','WindDir','IceContact100m','IceContactMLH',
                                      'LandContact','OceanContact','Water_Sal','sqrt_Hg0'], 1)
...
loadingsHg0.to_csv('/Users/ncp532/Documents/Data/PCA_Hg0/PC_Loadings_Hg0_noBrO.csv')
...
df_PC_Hg0 = pd.concat([PC1, PC2, PC3, PC4, PC5, PC6, PC7, PC8, PC9, PC10,
                       PC11,PC12], axis=1, join='inner')#,PC13,PC14,PC15,PC16,PC17,PC18,PC19,PC20,
                       #PC21,PC22,PC23], axis=1, join='inner')
df_PC_Hg0.columns = ['PC1', 'PC2', 'PC3', 'PC4', 'PC5', 'PC6', 'PC7', 'PC8', 'PC9', 'PC10',
                     'PC11','PC12']#,'PC13','PC14','PC15','PC16','PC17','PC18','PC19','PC20',
                     #'PC21','PC22','PC23']
df_PC_Hg0.to_csv('/Users/ncp532/Documents/Data/PCA_Hg0/PC_Hg0_noBrO.csv')
...
dataPCA_Hg0  = pd.DataFrame({'PC1': PC1, 'PC2': PC2, 'PC3': PC3, 'PC4': PC4, 'PC5': PC5, 'PC6': PC6, 'PC7': PC7, 'PC8': PC8, 'PC9': PC9, 'PC10': PC10,
                             'PC11':PC11,'PC12':PC12, 'z': dfPCA_Hg0['sqrt_Hg0']})#,'PC13':PC13,'PC14':PC14,'PC15':PC15,'PC16':PC16,'PC17':PC17,'PC18':PC18,'PC19':PC19,'PC20': PC20,
...
model_PC_Hg0  = ols("z ~ PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + PC11 + PC12", dataPCA_Hg0).fit()  # Surface StatsModel (ols)
...
# Fit the model
PLS_Hg0.fit(Hg0_Variables,dfPCA_Hg0['ng/m3'])
...
dfLinearRegressionHg0 = pd.DataFrame({'R (Hg0)':       [r_O3,  r_SurfTemp,  r_SLP,  r_WS10m,  r_MLH,  r_PTD1000m,  r_PTD100m,  r_SolRad,  r_IceContact,  r_SeaIceConc,  r_WaterTemp,  r_RelHum],
                                      'R^2 (Hg0)':     [r2_O3, r2_SurfTemp, r2_SLP, r2_WS10m, r2_MLH, r2_PTD1000m, r2_PTD100m, r2_SolRad, r2_IceContact, r2_SeaIceConc, r2_WaterTemp, r2_RelHum],
                                      'p-value (Hg0)': [p_O3,  p_SurfTemp,  p_SLP,  p_WS10m,  p_MLH,  p_PTD1000m,  p_PTD100m,  p_SolRad,  p_IceContact,  p_SeaIceConc,  p_WaterTemp,  p_RelHum]})

dfLinearRegressionHg0.index = ['O3','SurfTemp','SurfPres','WS10m','MLH','PTD1000m','PTD100m','SolRad','IceContact','SeaIceConc','WaterTemp','RelHum']
dfLinearRegressionHg0.to_csv('/Users/ncp532/Documents/Data/PCA_Hg0/LinearRegressionHg0_noBrO.csv')
...
dfPC_IntCoef.to_csv('/Users/ncp532/Documents/Data/PCA_Hg0/IntCoef_noBrO.csv')

# Export analysis of variance results
dfAnova_PC_Hg0  = pd.DataFrame(anova_results_PC_Hg0)
dfAnova_PC_Hg0.to_csv('/Users/ncp532/Documents/Data/PCA_Hg0/Anova_PC_Hg0_noBrO.csv')
...
df1.to_csv('/Users/ncp532/Documents/Data/PCA_Hg0/Hg0_Pred_CAMMPCAN_noBrO.csv')
